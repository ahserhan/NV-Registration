...
if __name__ == '__main__':
    ...
    size = 60 # size of the drawing area [micron]
    R_sil = 5 # radius of SIL [micron]
    R_cone = 2.2*R_sil # outer radius of the cone [micron]
    ds = 0.072 # step width in the x-y-plane [micron] 
    N = 200 # number of slices
    # mu = 1.0 # milling speed [micron / microsecond]
    depth_to_time = 1.168e5# [100* nanosecond / micron] Asher:This gives the first entry with unit 100* ns
