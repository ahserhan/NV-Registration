...
if __name__ == '__main__':
    ...
    size = 50 # size of the drawing area [micron]
    R_sil = 5 # radius of SIL [micron]
    R_cone = 11 # outer radius of the cone [micron]
    ds = 0.08 # step width in the x-y-plane [micron] 
    N = 10 # number of slices
    # mu = 1.0 # milling speed [micron / microsecond]
    depth_to_time = 1.47e5 # [100* nanosecond / micron] Asher:This gives the first entry with unit 100* ns, assuming cylindrical beam
    ...
    for n, slice in enumerate(slices):
        ...
        scene.addItem( Path(slice, depth_to_time),(0*size,0*size)) # place the structure in the center of the drawing area
